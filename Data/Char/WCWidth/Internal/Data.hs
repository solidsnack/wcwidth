module Data.Char.WCWidth.Internal.Data where

import Data.Char.WCWidth.Internal.RangeSet

wideEastAsian :: CharRangeSet
wideEastAsian = fromAscList wideEastAsianRaw

wideEastAsianRaw :: RawCharRangeSet
wideEastAsianRaw = [
...
zeroWidth :: CharRangeSet
zeroWidth = fromAscList zeroWidthRaw

zeroWidthRaw :: RawCharRangeSet
zeroWidthRaw = [
...
basicZero :: CharRangeSet
basicZero = fromAscList basicZeroRaw

basicZeroRaw :: RawCharRangeSet
basicZeroRaw = [
  (0, 0),
  (0x034f, 0x034f),
  (0x200b, 0x200f),
...
ctrlChars :: CharRangeSet
ctrlChars = fromAscList ctrlCharsRaw

ctrlCharsRaw :: RawCharRangeSet
ctrlCharsRaw = [
  (1, 32),
  (0x07f, 0x09F)
  ]
